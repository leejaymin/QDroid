...
.method public constructor <init>(Lcom/trilead/ssh2/channel/DynamicAcceptThread;Lnet/sourceforge/jsocks/server/ServerAuthenticator;Ljava/net/Socket;)V
    ...
    invoke-virtual {p1, v0}, Lcom/trilead/ssh2/channel/DynamicAcceptThread;->setName(Ljava/lang/String;)V
...
.method private onConnect(Lnet/sourceforge/jsocks/ProxyMessage;)V
    ...
    .line 170
    .local v11, l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    ...
    invoke-direct {v13, v3, v4, v5}, Lnet/sourceforge/jsocks/Socks5Message;-><init>(ILjava/net/InetAddress;I)V
    ...
    #getter for: Lcom/trilead/ssh2/channel/DynamicAcceptThread;->cm:Lcom/trilead/ssh2/channel/ChannelManager;
    invoke-static {v3}, Lcom/trilead/ssh2/channel/DynamicAcceptThread;->access$0(Lcom/trilead/ssh2/channel/DynamicAcceptThread;)Lcom/trilead/ssh2/channel/ChannelManager;
    ...
    .line 187
    invoke-virtual {v3, v9, v4, v5, v6}, Lcom/trilead/ssh2/channel/ChannelManager;->openDirectTCPIPChannel(Ljava/lang/String;ILjava/lang/String;I)Lcom/trilead/ssh2/channel/Channel;
    :try_end_0
    ...
    iget-object v3, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->sock:Ljava/net/Socket;

    iget-object v4, v1, Lcom/trilead/ssh2/channel/Channel;->stdoutStream:Lcom/trilead/ssh2/channel/ChannelInputStream;

    iget-object v5, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->out:Ljava/io/OutputStream;
    ...
    iget-object v5, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->sock:Ljava/net/Socket;

    iget-object v6, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->in:Ljava/io/InputStream;

    iget-object v7, v1, Lcom/trilead/ssh2/channel/Channel;->stdinStream:Lcom/trilead/ssh2/channel/ChannelOutputStream;
    ...
    .line 222
    .end local v11           #l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    .local v2, l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    const/4 v3, 0x1
    ...
    .end local v2           #l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    .end local v9           #destHost:Ljava/lang/String;
    .restart local v11       #l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    ...
    invoke-direct {v13, v3, v4, v5}, Lnet/sourceforge/jsocks/Socks4Message;-><init>(ILjava/net/InetAddress;I)V
    ...
    .end local v11           #l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    .restart local v2       #l2r:Lcom/trilead/ssh2/channel/StreamForwarder;
    move-object v0, v12
    ...
    :goto_3
    :try_start_4
    iget-object v3, v1, Lcom/trilead/ssh2/channel/Channel;->cm:Lcom/trilead/ssh2/channel/ChannelManager;
    ...
    .line 213
    invoke-virtual {v3, v1, v4, v5}, Lcom/trilead/ssh2/channel/ChannelManager;->closeChannel(Lcom/trilead/ssh2/channel/Channel;Ljava/lang/String;Z)V
    :try_end_4
...
.method private readMsg(Ljava/io/InputStream;)Lnet/sourceforge/jsocks/ProxyMessage;
    ...
    .line 95
    instance-of v3, p1, Ljava/io/PushbackInputStream;
    ...
    .line 100
    .local v1, push_in:Ljava/io/PushbackInputStream;
    :goto_0
    ...
    invoke-direct {v0, v1, v4}, Lnet/sourceforge/jsocks/Socks5Message;-><init>(Ljava/io/InputStream;Z)V
    ...
    .end local v1           #push_in:Ljava/io/PushbackInputStream;
    ...
    .restart local v1       #push_in:Ljava/io/PushbackInputStream;
    goto :goto_0
    ...
    invoke-direct {v0, v1, v4}, Lnet/sourceforge/jsocks/Socks4Message;-><init>(Ljava/io/InputStream;Z)V
...
.method private sendErrorMessage(I)V
    ...
    .prologue
    .line 117
    iget-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->msg:Lnet/sourceforge/jsocks/ProxyMessage;
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->out:Ljava/io/OutputStream;
...
.method private startSession()V
    ...
    .prologue
    .line 141
    iget-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->sock:Ljava/net/Socket;
    ...
    iput-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->in:Ljava/io/InputStream;
    ...
    iput-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->out:Ljava/io/OutputStream;

    .line 160
    iget-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->in:Ljava/io/InputStream;

    invoke-direct {p0, v1}, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->readMsg(Ljava/io/InputStream;)Lnet/sourceforge/jsocks/ProxyMessage;

    move-result-object v1

    iput-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->msg:Lnet/sourceforge/jsocks/ProxyMessage;

    .line 161
    iget-object v1, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->msg:Lnet/sourceforge/jsocks/ProxyMessage;

    invoke-direct {p0, v1}, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->handleRequest(Lnet/sourceforge/jsocks/ProxyMessage;)V
...
.method public run()V
    ...
    .line 88
    iget-object v2, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->auth:Lnet/sourceforge/jsocks/server/ServerAuthenticator;
    ...
    .line 86
    :cond_3
    invoke-direct {p0, v0}, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->sendErrorMessage(I)V
    :try_end_1
    ...
    .line 88
    iget-object v3, p0, Lcom/trilead/ssh2/channel/DynamicAcceptThread$DynamicAcceptRunnable;->auth:Lnet/sourceforge/jsocks/server/ServerAuthenticator;
