...
.field private c:Lcom/sun/mail/util/TraceInputStream;

.field private volatile d:Lcom/sun/mail/iap/ResponseInputStream;

.field protected debug:Z

.field private e:Lcom/sun/mail/util/TraceOutputStream;

.field private volatile f:Ljava/io/DataOutputStream;

.field private g:I

.field private volatile h:Ljava/util/Vector;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sun/mail/iap/Protocol;->j:[B
...
.method public constructor <init>(Ljava/io/InputStream;Ljava/io/OutputStream;Z)V
    ...
    iput-boolean v1, p0, Lcom/sun/mail/iap/Protocol;->b:Z

    iput v1, p0, Lcom/sun/mail/iap/Protocol;->g:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->h:Ljava/util/Vector;
    ...
    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->c:Lcom/sun/mail/util/TraceInputStream;

    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->c:Lcom/sun/mail/util/TraceInputStream;
    ...
    iget-object v1, p0, Lcom/sun/mail/iap/Protocol;->c:Lcom/sun/mail/util/TraceInputStream;

    invoke-direct {v0, v1}, Lcom/sun/mail/iap/ResponseInputStream;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->d:Lcom/sun/mail/iap/ResponseInputStream;
    ...
    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->e:Lcom/sun/mail/util/TraceOutputStream;

    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->e:Lcom/sun/mail/util/TraceOutputStream;
    ...
    iget-object v2, p0, Lcom/sun/mail/iap/Protocol;->e:Lcom/sun/mail/util/TraceOutputStream;

    invoke-direct {v1, v2}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;)V

    invoke-direct {v0, v1}, Ljava/io/DataOutputStream;-><init>(Ljava/io/OutputStream;)V

    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->f:Ljava/io/DataOutputStream;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/sun/mail/iap/Protocol;->i:J
...
.method public constructor <init>(Ljava/lang/String;IZLjava/io/PrintStream;Ljava/util/Properties;Ljava/lang/String;Z)V
    ...
    iput-object v2, p0, Lcom/sun/mail/iap/Protocol;->h:Ljava/util/Vector;
    ...
    iput-object v2, p0, Lcom/sun/mail/iap/Protocol;->a:Ljava/net/Socket;
    ...
    invoke-direct {p0, p4}, Lcom/sun/mail/iap/Protocol;->a(Ljava/io/PrintStream;)V
    ...
    iput-boolean v0, p0, Lcom/sun/mail/iap/Protocol;->b:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-boolean v0, p0, Lcom/sun/mail/iap/Protocol;->b:Z
    ...
    iget-boolean v1, p0, Lcom/sun/mail/iap/Protocol;->b:Z
...
.method private a(Ljava/io/PrintStream;)V
    ...
    iget-object v1, p0, Lcom/sun/mail/iap/Protocol;->a:Ljava/net/Socket;
...
.method public declared-synchronized addResponseHandler(Lcom/sun/mail/iap/ResponseHandler;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->h:Ljava/util/Vector;
...
.method public declared-synchronized command(Ljava/lang/String;Lcom/sun/mail/iap/Argument;)[Lcom/sun/mail/iap/Response;
    ...
    iput-wide v1, p0, Lcom/sun/mail/iap/Protocol;->i:J
    :try_end_2
...
.method public declared-synchronized disconnect()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->a:Ljava/net/Socket;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_2
    iput-object v0, p0, Lcom/sun/mail/iap/Protocol;->a:Ljava/net/Socket;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method protected getInputStream()Lcom/sun/mail/iap/ResponseInputStream;
    ...
    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->d:Lcom/sun/mail/iap/ResponseInputStream;
...
.method protected getOutputStream()Ljava/io/OutputStream;
    ...
    iget-object v0, p0, Lcom/sun/mail/iap/Protocol;->f:Ljava/io/DataOutputStream;
...
.method public getTimestamp()J
    ...
    iget-wide v0, p0, Lcom/sun/mail/iap/Protocol;->i:J
...
.method public declared-synchronized startTLS(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/sun/mail/iap/Protocol;->a(Ljava/io/PrintStream;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public writeCommand(Ljava/lang/String;Lcom/sun/mail/iap/Argument;)Ljava/lang/String;
    ...
    iget v1, p0, Lcom/sun/mail/iap/Protocol;->g:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lcom/sun/mail/iap/Protocol;->g:I
    ...
    iget-object v1, p0, Lcom/sun/mail/iap/Protocol;->f:Ljava/io/DataOutputStream;
    ...
    sget-object v2, Lcom/sun/mail/iap/Protocol;->j:[B
