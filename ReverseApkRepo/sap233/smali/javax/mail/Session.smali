...
# static fields
.field private static j:Ljavax/mail/Session;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljavax/mail/Session;->j:Ljavax/mail/Session;
...
.method private constructor <init>(Ljava/util/Properties;Ljavax/mail/Authenticator;)V
    ...
    iput-object v0, p0, Ljavax/mail/Session;->f:Ljava/util/Vector;

    new-instance v0, Ljava/util/Hashtable;

    invoke-direct {v0}, Ljava/util/Hashtable;-><init>()V

    iput-object v0, p0, Ljavax/mail/Session;->g:Ljava/util/Hashtable;
    ...
    iput-object v0, p0, Ljavax/mail/Session;->i:Ljava/util/Properties;
    ...
    invoke-direct {p0, v0}, Ljavax/mail/Session;->a(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0}, Ljavax/mail/e;-><init>(Ljavax/mail/Session;)V
    ...
    invoke-direct {p0, v0, v1}, Ljavax/mail/Session;->a(Ljava/lang/String;Ljavax/mail/l;)V
    :try_end_0
    ...
    invoke-direct {p0, v0, v6, v1}, Ljavax/mail/Session;->b(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V

    const-string v0, "/META-INF/javamail.default.providers"

    invoke-direct {p0, v0, v6, v1}, Ljavax/mail/Session;->a(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V

    iget-object v0, p0, Ljavax/mail/Session;->f:Ljava/util/Vector;
    ...
    iget-object v1, p0, Ljavax/mail/Session;->g:Ljava/util/Hashtable;
    ...
    :cond_5
    new-instance v0, Ljavax/mail/f;

    invoke-direct {v0, p0}, Ljavax/mail/f;-><init>(Ljavax/mail/Session;)V

    const-string v1, "/META-INF/javamail.default.address.map"

    invoke-direct {p0, v1, v6, v0}, Ljavax/mail/Session;->a(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V

    const-string v1, "META-INF/javamail.address.map"

    invoke-direct {p0, v1, v6, v0}, Ljavax/mail/Session;->b(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V
    ...
    invoke-direct {p0, v1, v0}, Ljavax/mail/Session;->a(Ljava/lang/String;Ljavax/mail/l;)V
    :try_end_1
    .catch Ljava/lang/SecurityException; {:try_start_1 .. :try_end_1} :catch_1

    :cond_6
    :goto_2
    iget-object v0, p0, Ljavax/mail/Session;->i:Ljava/util/Properties;
    ...
    iget-boolean v1, p0, Ljavax/mail/Session;->d:Z
...
.method private static a(Ljava/lang/Class;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    :try_start_0
    new-instance v0, Ljavax/mail/h;

    invoke-direct {v0, p0, p1}, Ljavax/mail/h;-><init>(Ljava/lang/Class;Ljava/lang/String;)V
...
.method private static a(Ljava/net/URL;)Ljava/io/InputStream;
    ...
    :try_start_0
    new-instance v0, Ljavax/mail/k;

    invoke-direct {v0, p0}, Ljavax/mail/k;-><init>(Ljava/net/URL;)V
...
.method private static a()Ljava/lang/ClassLoader;
    ...
    new-instance v0, Ljavax/mail/g;

    invoke-direct {v0}, Ljavax/mail/g;-><init>()V
...
.method static synthetic a(Ljavax/mail/Session;)Ljava/util/Properties;
    .locals 1
...
.method private a(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Store;
    .locals 2
    ...
    :cond_1
    :try_start_0
    invoke-direct {p0, p1, p2}, Ljavax/mail/Session;->c(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljava/lang/Object;
...
.method private a(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V
    .locals 4

    const/4 v1, 0x0

    :try_start_0
    invoke-static {p2, p1}, Ljavax/mail/Session;->a(Ljava/lang/Class;Ljava/lang/String;)Ljava/io/InputStream;

    move-result-object v1

    if-eqz v1, :cond_2

    invoke-interface {p3, v1}, Ljavax/mail/l;->a(Ljava/io/InputStream;)V
...
.method private a(Ljava/lang/String;Ljavax/mail/l;)V
    .locals 4
    ...
    :try_start_1
    invoke-interface {p2, v1}, Ljavax/mail/l;->a(Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, v2}, Ljavax/mail/Session;->a(Ljava/lang/String;)V
...
.method static synthetic a(Ljavax/mail/Session;Ljava/io/InputStream;)V
    .locals 12
...
.method private b(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Transport;
    .locals 2
...
.method private b(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V
    .locals 8

    const/4 v2, 0x0

    :try_start_0
    invoke-static {}, Ljavax/mail/Session;->a()Ljava/lang/ClassLoader;
    ...
    new-instance v1, Ljavax/mail/i;

    invoke-direct {v1, v0, p1}, Ljavax/mail/i;-><init>(Ljava/lang/ClassLoader;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, p2, p3}, Ljavax/mail/Session;->a(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/l;)V
    ...
    :cond_4
    :try_start_1
    new-instance v0, Ljavax/mail/j;

    invoke-direct {v0, p1}, Ljavax/mail/j;-><init>(Ljava/lang/String;)V
    ...
    iget-boolean v5, p0, Ljavax/mail/Session;->d:Z
    ...
    invoke-direct {p0, v5}, Ljavax/mail/Session;->a(Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_4

    :cond_6
    :try_start_2
    invoke-static {v0}, Ljavax/mail/Session;->a(Ljava/net/URL;)Ljava/io/InputStream;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Ljava/lang/SecurityException; {:try_start_2 .. :try_end_2} :catch_2
    ...
    invoke-direct {p0, v1}, Ljavax/mail/Session;->a(Ljava/lang/String;)V
    :try_end_6
...
.method private c(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljava/lang/Object;
    .locals 7
...
.method public static declared-synchronized getDefaultInstance(Ljava/util/Properties;Ljavax/mail/Authenticator;)Ljavax/mail/Session;
    ...
    :try_start_0
    sget-object v0, Ljavax/mail/Session;->j:Ljavax/mail/Session;
    ...
    iget-object v0, v0, Ljavax/mail/Session;->b:Ljavax/mail/Authenticator;
...
.method public final declared-synchronized addProvider(Ljavax/mail/Provider;)V
    ...
    iget-object v0, p0, Ljavax/mail/Session;->g:Ljava/util/Hashtable;
...
.method public final declared-synchronized getProviders()[Ljavax/mail/Provider;
    ...
    iget-object v1, p0, Ljavax/mail/Session;->f:Ljava/util/Vector;
...
.method public final getStore(Ljavax/mail/Provider;)Ljavax/mail/Store;
    ...
    invoke-direct {p0, p1, v0}, Ljavax/mail/Session;->a(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Store;
...
.method public final getStore(Ljavax/mail/URLName;)Ljavax/mail/Store;
    ...
    invoke-direct {p0, v0, p1}, Ljavax/mail/Session;->a(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Store;
...
.method public final getTransport(Ljavax/mail/Provider;)Ljavax/mail/Transport;
    ...
    invoke-direct {p0, p1, v0}, Ljavax/mail/Session;->b(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Transport;
...
.method public final getTransport(Ljavax/mail/URLName;)Ljavax/mail/Transport;
    ...
    invoke-direct {p0, v0, p1}, Ljavax/mail/Session;->b(Ljavax/mail/Provider;Ljavax/mail/URLName;)Ljavax/mail/Transport;
...
.method public final requestPasswordAuthentication(Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/mail/PasswordAuthentication;
    ...
    invoke-virtual/range {v0 .. v5}, Ljavax/mail/Authenticator;->a(Ljava/net/InetAddress;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/mail/PasswordAuthentication;
