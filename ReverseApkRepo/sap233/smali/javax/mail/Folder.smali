...
# instance fields
.field private volatile a:Ljava/util/Vector;

.field private volatile b:Ljava/util/Vector;

.field private volatile c:Ljava/util/Vector;

.field private volatile d:Ljava/util/Vector;

.field private e:Ljavax/mail/a;
...
.method public constructor <init>(Ljavax/mail/Store;)V
    ...
    iput-object v1, p0, Ljavax/mail/Folder;->a:Ljava/util/Vector;

    iput-object v1, p0, Ljavax/mail/Folder;->b:Ljava/util/Vector;

    iput-object v1, p0, Ljavax/mail/Folder;->c:Ljava/util/Vector;

    iput-object v1, p0, Ljavax/mail/Folder;->d:Ljava/util/Vector;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Ljavax/mail/Folder;->f:Ljava/lang/Object;
...
.method private a()V
    ...
    iget-object v1, p0, Ljavax/mail/Folder;->f:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Ljavax/mail/Folder;->e:Ljavax/mail/a;
    ...
    iget-object v2, p0, Ljavax/mail/Folder;->e:Ljavax/mail/a;

    new-instance v3, Ljavax/mail/c;

    invoke-direct {v3}, Ljavax/mail/c;-><init>()V

    invoke-virtual {v2, v3, v0}, Ljavax/mail/a;->a(Ljavax/mail/event/MailEvent;Ljava/util/Vector;)V

    const/4 v0, 0x0

    iput-object v0, p0, Ljavax/mail/Folder;->e:Ljavax/mail/a;
...
.method private a(Ljavax/mail/event/MailEvent;Ljava/util/Vector;)V
    ...
    new-instance v0, Ljavax/mail/a;

    invoke-direct {v0}, Ljavax/mail/a;-><init>()V
    ...
    iget-object v1, p0, Ljavax/mail/Folder;->e:Ljavax/mail/a;

    invoke-virtual {v1, p1, v0}, Ljavax/mail/a;->a(Ljavax/mail/event/MailEvent;Ljava/util/Vector;)V
...
.method public declared-synchronized addConnectionListener(Ljavax/mail/event/ConnectionListener;)V
    ...
    :try_start_0
    iget-object v0, p0, Ljavax/mail/Folder;->a:Ljava/util/Vector;
    ...
    iput-object v0, p0, Ljavax/mail/Folder;->a:Ljava/util/Vector;
...
.method public declared-synchronized addFolderListener(Ljavax/mail/event/FolderListener;)V
    ...
    :try_start_0
    iget-object v0, p0, Ljavax/mail/Folder;->b:Ljava/util/Vector;
    ...
    iput-object v0, p0, Ljavax/mail/Folder;->b:Ljava/util/Vector;
...
.method public declared-synchronized addMessageCountListener(Ljavax/mail/event/MessageCountListener;)V
    ...
    :try_start_0
    iget-object v0, p0, Ljavax/mail/Folder;->c:Ljava/util/Vector;
    ...
    iput-object v0, p0, Ljavax/mail/Folder;->c:Ljava/util/Vector;
...
.method public finalize()V
    ...
    invoke-direct {p0}, Ljavax/mail/Folder;->a()V
...
.method protected notifyConnectionListeners(I)V
    ...
    iget-object v1, p0, Ljavax/mail/Folder;->a:Ljava/util/Vector;

    invoke-direct {p0, v0, v1}, Ljavax/mail/Folder;->a(Ljavax/mail/event/MailEvent;Ljava/util/Vector;)V
...
.method protected notifyFolderListeners(I)V
    ...
    iget-object v1, p0, Ljavax/mail/Folder;->b:Ljava/util/Vector;
...
.method protected notifyMessageAddedListeners([Ljavax/mail/Message;)V
    ...
    iget-object v1, p0, Ljavax/mail/Folder;->c:Ljava/util/Vector;
