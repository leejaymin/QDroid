...
# static fields
.field private static a:Lcom/sun/activation/registries/MailcapFile;


# instance fields
.field private b:[Lcom/sun/activation/registries/MailcapFile;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljavax/activation/MailcapCommandMap;->a:Lcom/sun/activation/registries/MailcapFile;
...
.method public constructor <init>()V
    ...
    invoke-static {v1}, Ljavax/activation/MailcapCommandMap;->b(Ljava/lang/String;)Lcom/sun/activation/registries/MailcapFile;
    ...
    invoke-direct {p0, v0, v1}, Ljavax/activation/MailcapCommandMap;->a(Ljava/util/List;Ljava/lang/String;)V
    ...
    :try_start_2
    sget-object v2, Ljavax/activation/MailcapCommandMap;->a:Lcom/sun/activation/registries/MailcapFile;

    if-nez v2, :cond_2

    const-string v2, "mailcap.default"

    invoke-direct {p0, v2}, Ljavax/activation/MailcapCommandMap;->a(Ljava/lang/String;)Lcom/sun/activation/registries/MailcapFile;

    move-result-object v2

    sput-object v2, Ljavax/activation/MailcapCommandMap;->a:Lcom/sun/activation/registries/MailcapFile;
    ...
    sget-object v1, Ljavax/activation/MailcapCommandMap;->a:Lcom/sun/activation/registries/MailcapFile;
    ...
    iput-object v1, p0, Ljavax/activation/MailcapCommandMap;->b:[Lcom/sun/activation/registries/MailcapFile;

    iget-object v1, p0, Ljavax/activation/MailcapCommandMap;->b:[Lcom/sun/activation/registries/MailcapFile;
    ...
    iput-object v0, p0, Ljavax/activation/MailcapCommandMap;->b:[Lcom/sun/activation/registries/MailcapFile;
...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    iget-object v0, p0, Ljavax/activation/MailcapCommandMap;->b:[Lcom/sun/activation/registries/MailcapFile;
...
.method private a(Ljava/lang/String;)Lcom/sun/activation/registries/MailcapFile;
    .locals 5
    ...
    invoke-static {v0, p1}, Ljavax/activation/e;->a(Ljava/lang/Class;Ljava/lang/String;)Ljava/io/InputStream;
    :try_end_0
...
.method private a(Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-static {v0, p2}, Ljavax/activation/e;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)[Ljava/net/URL;
    ...
    invoke-direct {p0, v0}, Ljavax/activation/MailcapCommandMap;->a(Ljava/lang/String;)Lcom/sun/activation/registries/MailcapFile;
    ...
    :cond_5
    :try_start_1
    invoke-static {p2}, Ljavax/activation/e;->a(Ljava/lang/String;)[Ljava/net/URL;
    ...
    :cond_7
    :try_start_2
    invoke-static {v5}, Ljavax/activation/e;->a(Ljava/net/URL;)Ljava/io/InputStream;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private static b(Ljava/lang/String;)Lcom/sun/activation/registries/MailcapFile;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lcom/sun/activation/registries/MailcapFile;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private c(Ljava/lang/String;)Ljavax/activation/DataContentHandler;
    .locals 3
...
.method public declared-synchronized createDataContentHandler(Ljava/lang/String;)Ljavax/activation/DataContentHandler;
    ...
    invoke-direct {p0, v0}, Ljavax/activation/MailcapCommandMap;->c(Ljava/lang/String;)Ljavax/activation/DataContentHandler;
...
.method public declared-synchronized getAllCommands(Ljava/lang/String;)[Ljavax/activation/CommandInfo;
    ...
    :goto_0
    iget-object v3, p0, Ljavax/activation/MailcapCommandMap;->b:[Lcom/sun/activation/registries/MailcapFile;
    ...
    invoke-static {v3, v2}, Ljavax/activation/MailcapCommandMap;->b(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-static {v1, v2}, Ljavax/activation/MailcapCommandMap;->b(Ljava/util/Map;Ljava/util/List;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized getPreferredCommands(Ljava/lang/String;)[Ljavax/activation/CommandInfo;
    ...
    invoke-static {v3, v2}, Ljavax/activation/MailcapCommandMap;->a(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-static {v1, v2}, Ljavax/activation/MailcapCommandMap;->a(Ljava/util/Map;Ljava/util/List;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
