...
.field private U:Landroid/support/v4/view/as;

.field private V:Landroid/support/v4/view/as;
...
.field private final e:Landroid/support/v4/view/ao;
...
.field private m:Landroid/support/v4/view/at;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->e:Landroid/support/v4/view/ao;
...
.method private a(II)Landroid/support/v4/view/ao;
    .locals 2
    ...
    iput p1, v0, Landroid/support/v4/view/ao;->b:I
    ...
    iput-object v1, v0, Landroid/support/v4/view/ao;->a:Ljava/lang/Object;

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/v;

    const/high16 v1, 0x3f80

    iput v1, v0, Landroid/support/v4/view/ao;->d:F
...
.method private a(Landroid/view/View;)Landroid/support/v4/view/ao;
    .locals 4
    ...
    iget-object v3, v0, Landroid/support/v4/view/ao;->a:Ljava/lang/Object;
...
.method private a(I)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/ao;
    ...
    iget v4, v0, Landroid/support/v4/view/ao;->b:I
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ao;
    ...
    iget v10, v6, Landroid/support/v4/view/ao;->d:F
    ...
    iget v11, v0, Landroid/support/v4/view/ao;->b:I

    if-ne v5, v11, :cond_2

    iget-boolean v11, v0, Landroid/support/v4/view/ao;->c:Z
    ...
    iget-object v0, v0, Landroid/support/v4/view/ao;->a:Ljava/lang/Object;

    invoke-virtual {v11, v0}, Landroid/support/v4/view/v;->a(Ljava/lang/Object;)V
    ...
    iget v0, v0, Landroid/support/v4/view/ao;->d:F
    ...
    invoke-direct {p0, v5, v0}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ao;
    ...
    :cond_a
    iget v2, v6, Landroid/support/v4/view/ao;->d:F
    ...
    iget v7, v0, Landroid/support/v4/view/ao;->b:I

    if-ne v5, v7, :cond_2b

    iget-boolean v7, v0, Landroid/support/v4/view/ao;->c:Z
    ...
    invoke-virtual {v7, v0}, Landroid/support/v4/view/v;->a(Ljava/lang/Object;)V
    ...
    :cond_f
    invoke-direct {p0, v5, v3}, Landroid/support/v4/view/ViewPager;->a(II)Landroid/support/v4/view/ao;
    ...
    iget v2, v1, Landroid/support/v4/view/ao;->b:I

    iget v0, v6, Landroid/support/v4/view/ao;->b:I

    if-ge v2, v0, :cond_15

    const/4 v0, 0x0

    iget v3, v1, Landroid/support/v4/view/ao;->e:F

    iget v1, v1, Landroid/support/v4/view/ao;->d:F
    ...
    :goto_f
    iget v8, v0, Landroid/support/v4/view/ao;->b:I
    ...
    :cond_14
    iput v3, v0, Landroid/support/v4/view/ao;->e:F
    ...
    :cond_17
    iget v8, v0, Landroid/support/v4/view/ao;->d:F
    ...
    iget v2, v6, Landroid/support/v4/view/ao;->e:F
    ...
    iget v0, v6, Landroid/support/v4/view/ao;->e:F
    ...
    iget v3, v6, Landroid/support/v4/view/ao;->d:F
    ...
    :goto_17
    iget v9, v0, Landroid/support/v4/view/ao;->b:I
    ...
    :cond_1b
    iget v9, v0, Landroid/support/v4/view/ao;->d:F

    add-float/2addr v9, v5

    sub-float/2addr v2, v9

    iput v2, v0, Landroid/support/v4/view/ao;->e:F
    ...
    iget v1, v6, Landroid/support/v4/view/ao;->d:F
    ...
    iget v4, v0, Landroid/support/v4/view/ao;->d:F
    ...
    iget-object v0, v6, Landroid/support/v4/view/ao;->a:Ljava/lang/Object;

    :goto_1a
    invoke-virtual {v1, v0}, Landroid/support/v4/view/v;->b(Ljava/lang/Object;)V
    ...
    iget-boolean v4, v0, Landroid/support/v4/view/ap;->a:Z

    if-nez v4, :cond_22

    iget v4, v0, Landroid/support/v4/view/ap;->c:F
    ...
    invoke-direct {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ao;

    move-result-object v3

    if-eqz v3, :cond_22

    iget v3, v3, Landroid/support/v4/view/ao;->d:F

    iput v3, v0, Landroid/support/v4/view/ap;->c:F
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ao;

    move-result-object v2

    if-eqz v2, :cond_27

    iget v2, v2, Landroid/support/v4/view/ao;->b:I
...
.method private a(IIII)V
    ...
    iget v3, v3, Landroid/support/v4/view/ao;->e:F
    ...
    iget v0, v0, Landroid/support/v4/view/ao;->e:F
...
.method private a(IZZI)V
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/ao;->c:Z
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/view/ViewPager;->b(I)Landroid/support/v4/view/ao;
    ...
    iget v1, v1, Landroid/support/v4/view/ao;->e:F
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->U:Landroid/support/v4/view/as;
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/as;
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->U:Landroid/support/v4/view/as;

    if-eqz v1, :cond_f

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->U:Landroid/support/v4/view/as;

    invoke-interface {v1, p1}, Landroid/support/v4/view/as;->b(I)V

    :cond_f
    if-eqz v6, :cond_10

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->V:Landroid/support/v4/view/as;
...
.method private a(F)Z
    ...
    :goto_0
    iget v8, v1, Landroid/support/v4/view/ao;->b:I

    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/v;

    invoke-virtual {v9}, Landroid/support/v4/view/v;->b()I
...
.method private b(I)Landroid/support/v4/view/ao;
    .locals 3
    ...
    iget v2, v0, Landroid/support/v4/view/ao;->b:I
...
.method private c(I)Z
    ...
    invoke-virtual {v3}, Landroid/support/v4/view/v;->b()I
...
.method private e()Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->h()Landroid/support/v4/view/ao;
    ...
    iget v2, v1, Landroid/support/v4/view/ao;->e:F
...
.method private f()V
    ...
    iget-boolean v8, v0, Landroid/support/v4/view/ap;->a:Z
...
.method private g()V
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/ao;->c:Z
...
.method private h()Landroid/support/v4/view/ao;
    .locals 13
    ...
    iget v10, v0, Landroid/support/v4/view/ao;->b:I

    add-int/lit8 v11, v8, 0x1

    if-eq v10, v11, :cond_6

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->e:Landroid/support/v4/view/ao;

    add-float/2addr v6, v7

    add-float/2addr v6, v1

    iput v6, v0, Landroid/support/v4/view/ao;->e:F

    add-int/lit8 v6, v8, 0x1

    iput v6, v0, Landroid/support/v4/view/ao;->b:I

    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/v;

    iget v6, v0, Landroid/support/v4/view/ao;->b:I

    const/high16 v6, 0x3f80

    iput v6, v0, Landroid/support/v4/view/ao;->d:F
    ...
    :goto_3
    iget v6, v2, Landroid/support/v4/view/ao;->e:F

    iget v7, v2, Landroid/support/v4/view/ao;->d:F
    ...
    :cond_5
    iget v5, v2, Landroid/support/v4/view/ao;->b:I

    iget v4, v2, Landroid/support/v4/view/ao;->d:F
...
.method final a()V
    ...
    iget-boolean v6, v0, Landroid/support/v4/view/ap;->a:Z

    if-nez v6, :cond_2

    const/4 v6, 0x0

    iput v6, v0, Landroid/support/v4/view/ap;->c:F
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    iget v4, v4, Landroid/support/v4/view/ao;->b:I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-boolean v2, v0, Landroid/support/v4/view/ap;->a:Z

    instance-of v3, p1, Landroid/support/v4/view/an;

    or-int/2addr v2, v3

    iput-boolean v2, v0, Landroid/support/v4/view/ap;->a:Z
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/ap;->d:Z
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of v0, p1, Landroid/support/v4/view/ap;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->O:Landroid/support/v4/d/a;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/view/ap;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v4, v1, Landroid/support/v4/view/ao;->e:F
    ...
    iget v3, v1, Landroid/support/v4/view/ao;->b:I
    ...
    iget v10, v2, Landroid/support/v4/view/ao;->b:I
    ...
    iget v4, v1, Landroid/support/v4/view/ao;->d:F
    ...
    iget v11, v1, Landroid/support/v4/view/ao;->d:F
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v7, v1, Landroid/support/v4/view/ap;->a:Z

    if-eqz v7, :cond_4

    iget v7, v1, Landroid/support/v4/view/ap;->b:I
    ...
    iget-boolean v12, v1, Landroid/support/v4/view/ap;->a:Z

    if-nez v12, :cond_2

    move-object/from16 v0, p0

    invoke-direct {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ao;
    ...
    iget v12, v12, Landroid/support/v4/view/ao;->e:F
    ...
    iget-boolean v13, v1, Landroid/support/v4/view/ap;->d:Z

    if-eqz v13, :cond_1

    const/4 v13, 0x0

    iput-boolean v13, v1, Landroid/support/v4/view/ap;->d:Z
    ...
    iget v1, v1, Landroid/support/v4/view/ap;->c:F
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/view/ap;->a:Z

    if-eqz v1, :cond_3

    iget v1, v0, Landroid/support/v4/view/ap;->b:I
    ...
    :cond_2
    :goto_3
    iget v4, v0, Landroid/support/v4/view/ap;->width:I
    ...
    iget v2, v0, Landroid/support/v4/view/ap;->width:I
    ...
    :goto_4
    iget v11, v0, Landroid/support/v4/view/ap;->height:I
    ...
    iget v0, v0, Landroid/support/v4/view/ap;->height:I
    ...
    iget-boolean v5, v0, Landroid/support/v4/view/ap;->a:Z
    ...
    iget v0, v0, Landroid/support/v4/view/ap;->c:F
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    invoke-direct {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Landroid/support/v4/view/ao;

    move-result-object v6

    if-eqz v6, :cond_1

    iget v6, v6, Landroid/support/v4/view/ao;->b:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v6, Landroid/support/v4/view/ao;->e:F

    sub-float/2addr v2, v5

    iget v5, v6, Landroid/support/v4/view/ao;->d:F
...
.method public setAdapter(Landroid/support/v4/view/v;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/at;

    iget-object v0, v0, Landroid/support/v4/view/v;->a:Landroid/database/DataSetObservable;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/view/v;->a(Ljava/lang/Object;)V
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/ap;->a:Z
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/view/at;-><init>(Landroid/support/v4/view/ViewPager;B)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/at;

    :cond_4
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->g:Landroid/support/v4/view/v;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->m:Landroid/support/v4/view/at;

    iget-object v1, v1, Landroid/support/v4/view/v;->a:Landroid/database/DataSetObservable;
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/ar;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->W:Landroid/support/v4/view/ar;
...
.method public setOnPageChangeListener(Landroid/support/v4/view/as;)V
    ...
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->U:Landroid/support/v4/view/as;
