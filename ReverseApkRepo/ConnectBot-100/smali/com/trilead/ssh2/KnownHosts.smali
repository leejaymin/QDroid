...
.method private final checkHashed(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 200
    .local v10, salt_base64:Ljava/lang/String;
    ...
    .line 202
    .local v7, hash_base64:Ljava/lang/String;
    move-object v0, v12
    ...
    invoke-static {v12}, Lcom/trilead/ssh2/crypto/Base64;->decode([C)[B
    ...
    .line 215
    new-instance v11, Lcom/trilead/ssh2/crypto/digest/SHA1;

    invoke-direct {v11}, Lcom/trilead/ssh2/crypto/digest/SHA1;-><init>()V

    .line 217
    .local v11, sha1:Lcom/trilead/ssh2/crypto/digest/SHA1;
    array-length v12, v9

    invoke-virtual {v11}, Lcom/trilead/ssh2/crypto/digest/SHA1;->getDigestLength()I
    ...
    .line 210
    .end local v11           #sha1:Lcom/trilead/ssh2/crypto/digest/SHA1;
    :catch_0
    move-exception v12
    ...
    .restart local v11       #sha1:Lcom/trilead/ssh2/crypto/digest/SHA1;
    :cond_2
    move-object v0, v9

    move-object/from16 v1, p2

    invoke-static {v0, v1}, Lcom/trilead/ssh2/KnownHosts;->hmacSha1Hash([BLjava/lang/String;)[B
...
.method private checkKey(Ljava/lang/String;Ljava/lang/Object;)I
    ...
    iget-object v5, v1, Lcom/trilead/ssh2/KnownHosts$KnownHostsEntry;->patterns:[Ljava/lang/String;

    invoke-direct {p0, v5, p1}, Lcom/trilead/ssh2/KnownHosts;->hostnameMatches([Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 244
    iget-object v5, v1, Lcom/trilead/ssh2/KnownHosts$KnownHostsEntry;->key:Ljava/lang/Object;

    invoke-direct {p0, v5, p2}, Lcom/trilead/ssh2/KnownHosts;->matchKeys(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static final createBubblebabbleFingerprint(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    .line 842
    .local v0, raw:[B
    invoke-static {v0}, Lcom/trilead/ssh2/KnownHosts;->rawToBubblebabbleFingerprint([B)Ljava/lang/String;
...
.method public static final createHashedHostname(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 149
    new-instance v4, Lcom/trilead/ssh2/crypto/digest/SHA1;

    invoke-direct {v4}, Lcom/trilead/ssh2/crypto/digest/SHA1;-><init>()V

    .line 151
    .local v4, sha1:Lcom/trilead/ssh2/crypto/digest/SHA1;
    invoke-virtual {v4}, Lcom/trilead/ssh2/crypto/digest/SHA1;->getDigestLength()I
    ...
    .line 155
    invoke-static {v3, p0}, Lcom/trilead/ssh2/KnownHosts;->hmacSha1Hash([BLjava/lang/String;)[B
...
.method private final hostnameMatches([Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v6, v5, v6}, Lcom/trilead/ssh2/KnownHosts;->pseudoRegex([CI[CI)Z
...
.method private initialize(Ljava/io/File;)V
    ...
    invoke-direct {p0, v4}, Lcom/trilead/ssh2/KnownHosts;->initialize([C)V
...
.method private initialize([C)V
    ...
    invoke-static {v5}, Lcom/trilead/ssh2/crypto/Base64;->decode([C)[B
    ...
    invoke-virtual {p0, v2, v5, v4}, Lcom/trilead/ssh2/KnownHosts;->addHostkey([Ljava/lang/String;Ljava/lang/String;[B)V
...
.method private final matchKeys(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 445
    instance-of v5, p1, Lcom/trilead/ssh2/signature/RSAPublicKey;

    if-eqz v5, :cond_2

    instance-of v5, p2, Lcom/trilead/ssh2/signature/RSAPublicKey;
    ...
    check-cast v0, Lcom/trilead/ssh2/signature/RSAPublicKey;

    move-object v4, v0

    .line 448
    .local v4, savedRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    move-object v0, p2
    ...
    .line 450
    .local v2, remoteRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    invoke-virtual {v4}, Lcom/trilead/ssh2/signature/RSAPublicKey;->getE()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v2}, Lcom/trilead/ssh2/signature/RSAPublicKey;->getE()Ljava/math/BigInteger;
    ...
    .line 479
    .end local v4           #savedRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    .end local v2           #remoteRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    :goto_0
    return v5

    .line 453
    .restart local v2       #remoteRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    .restart local v4       #savedRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    :cond_0
    invoke-virtual {v4}, Lcom/trilead/ssh2/signature/RSAPublicKey;->getN()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v2}, Lcom/trilead/ssh2/signature/RSAPublicKey;->getN()Ljava/math/BigInteger;
    ...
    .end local v4           #savedRSAKey:Lcom/trilead/ssh2/signature/RSAPublicKey;
    :cond_2
    instance-of v5, p1, Lcom/trilead/ssh2/signature/DSAPublicKey;

    if-eqz v5, :cond_7

    instance-of v5, p2, Lcom/trilead/ssh2/signature/DSAPublicKey;
    ...
    .line 462
    .local v3, savedDSAKey:Lcom/trilead/ssh2/signature/DSAPublicKey;
    move-object v0, p2
    ...
    .line 464
    .local v1, remoteDSAKey:Lcom/trilead/ssh2/signature/DSAPublicKey;
    invoke-virtual {v3}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getG()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v1}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getG()Ljava/math/BigInteger;
    ...
    .line 467
    :cond_3
    invoke-virtual {v3}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getP()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v1}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getP()Ljava/math/BigInteger;
    ...
    .line 470
    :cond_4
    invoke-virtual {v3}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getQ()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v1}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getQ()Ljava/math/BigInteger;
    ...
    .line 473
    :cond_5
    invoke-virtual {v3}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getY()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {v1}, Lcom/trilead/ssh2/signature/DSAPublicKey;->getY()Ljava/math/BigInteger;
    ...
    .end local v3           #savedDSAKey:Lcom/trilead/ssh2/signature/DSAPublicKey;
    .end local v1           #remoteDSAKey:Lcom/trilead/ssh2/signature/DSAPublicKey;
    :cond_7
    move v5, v7
...
.method private final pseudoRegex([CI[CI)Z
    ...
    invoke-direct {p0, p1, v0, p3, v1}, Lcom/trilead/ssh2/KnownHosts;->pseudoRegex([CI[CI)Z
...
.method private recommendHostkeyAlgorithms(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/trilead/ssh2/KnownHosts;->getAllKeys(Ljava/lang/String;)Ljava/util/Vector;
    ...
    instance-of v4, v4, Lcom/trilead/ssh2/signature/RSAPublicKey;
    ...
    instance-of v4, v4, Lcom/trilead/ssh2/signature/DSAPublicKey;
...
.method public getPreferredServerHostkeyAlgorithmOrder(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 293
    .local v1, algos:[Ljava/lang/String;
    if-eqz v1, :cond_1
    ...
    .line 300
    .local v4, ipAdresses:[Ljava/net/InetAddress;
    :try_start_0
    ...
    invoke-direct {p0, v6}, Lcom/trilead/ssh2/KnownHosts;->recommendHostkeyAlgorithms(Ljava/lang/String;)[Ljava/lang/String;
