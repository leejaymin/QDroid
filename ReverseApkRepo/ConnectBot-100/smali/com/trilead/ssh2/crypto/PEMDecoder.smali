...
.method public static decode([CLjava/lang/String;)Ljava/lang/Object;
    ...
    .line 315
    .local v0, ps:Lcom/trilead/ssh2/crypto/PEMStructure;
    ...
    invoke-static {v0, p0}, Lcom/trilead/ssh2/crypto/PEMDecoder;->decryptPEM(Lcom/trilead/ssh2/crypto/PEMStructure;[B)V

    .line 323
    :cond_1
    iget p0, v0, Lcom/trilead/ssh2/crypto/PEMStructure;->pemType:I
    ...
    .line 325
    .end local p1
    new-instance p0, Lcom/trilead/ssh2/crypto/SimpleDERReader;

    iget-object p1, v0, Lcom/trilead/ssh2/crypto/PEMStructure;->data:[B

    invoke-direct {p0, p1}, Lcom/trilead/ssh2/crypto/SimpleDERReader;-><init>([B)V

    .line 327
    .local p0, dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    invoke-virtual {p0}, Lcom/trilead/ssh2/crypto/SimpleDERReader;->readSequenceAsByteArray()[B
    ...
    .end local v0           #ps:Lcom/trilead/ssh2/crypto/PEMStructure;
    if-eqz v0, :cond_2

    .line 330
    new-instance p0, Ljava/io/IOException;

    .end local p0           #dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    ...
    .line 332
    .restart local p0       #dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    .restart local p1       #seq:[B
    :cond_2
    invoke-virtual {p0, p1}, Lcom/trilead/ssh2/crypto/SimpleDERReader;->resetInput([B)V

    .line 334
    invoke-virtual {p0}, Lcom/trilead/ssh2/crypto/SimpleDERReader;->readInt()Ljava/math/BigInteger;
    ...
    .line 355
    .local p1, dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    ...
    .end local p1           #dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    invoke-direct {p0, p1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    throw p0

    .line 360
    .restart local p1       #dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    :cond_6
    invoke-virtual {p1, v2}, Lcom/trilead/ssh2/crypto/SimpleDERReader;->resetInput([B)V
    ...
    .line 367
    .restart local v0       #ps:Lcom/trilead/ssh2/crypto/PEMStructure;
    .restart local p1       #dr:Lcom/trilead/ssh2/crypto/SimpleDERReader;
    :cond_7
    invoke-virtual {p1}, Lcom/trilead/ssh2/crypto/SimpleDERReader;->readInt()Ljava/math/BigInteger;
    ...
    new-instance v4, Lcom/trilead/ssh2/signature/RSAPrivateKey;

    invoke-direct {v4, p0, v0, v1}, Lcom/trilead/ssh2/signature/RSAPrivateKey;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method private static final parsePEM([C)Lcom/trilead/ssh2/crypto/PEMStructure;
    .locals 7
    .parameter "pem"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 125
    new-instance v4, Lcom/trilead/ssh2/crypto/PEMStructure;

    invoke-direct {v4}, Lcom/trilead/ssh2/crypto/PEMStructure;-><init>()V

    .line 127
    .local v4, ps:Lcom/trilead/ssh2/crypto/PEMStructure;
    const/4 v1, 0x0
    ...
    iput v2, v4, Lcom/trilead/ssh2/crypto/PEMStructure;->pemType:I
    ...
    .line 184
    iput-object v5, v4, Lcom/trilead/ssh2/crypto/PEMStructure;->procType:[Ljava/lang/String;
    ...
    .line 190
    iput-object v5, v4, Lcom/trilead/ssh2/crypto/PEMStructure;->dekInfo:[Ljava/lang/String;
    ...
    .line 216
    invoke-static {p0}, Lcom/trilead/ssh2/crypto/Base64;->decode([C)[B

    move-result-object p0

    .end local p0           #pem_chars:[C
    iput-object p0, v4, Lcom/trilead/ssh2/crypto/PEMStructure;->data:[B

    .line 218
    iget-object p0, v4, Lcom/trilead/ssh2/crypto/PEMStructure;->data:[B
