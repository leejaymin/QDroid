...
.field private static final TOKEN_REGEX:Ljava/lang/String; = "access_token=(\\S*?)(&(\\S*))?"
...
.method public extract(Ljava/lang/String;)Lorg/scribe/model/Token;
    ...
    .line 25
    const-string v2, "access_token=(\\S*?)(&(\\S*))?"
    ...
    invoke-static {v2}, Lorg/scribe/utils/URLUtils;->formURLDecode(Ljava/lang/String;)Ljava/lang/String;
