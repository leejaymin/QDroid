...
.field mLoader:Landroid/support/v4/a/b;
...
# virtual methods
.method final callOnLoadFinished(Landroid/support/v4/a/b;Ljava/lang/Object;)V
    .locals 5
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Landroid/support/v4/a/b;Ljava/lang/Object;)V
    :try_end_0
...
.method final destroy()V
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/b;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Landroid/support/v4/a/b;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/b;Ljava/lang/Object;)V

    :cond_2
    return-void
.end method

.method public final onLoadComplete(Landroid/support/v4/a/b;Ljava/lang/Object;)V
    .locals 5
    ...
    invoke-virtual {v1, v2, v4}, Landroid/support/v4/c/c;->a(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Landroid/support/v4/a/b;Ljava/lang/Object;)V
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Landroid/support/v4/a/b;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/b;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroid/support/v4/a/b;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/a/b;->a(ILandroid/support/v4/a/c;)V
