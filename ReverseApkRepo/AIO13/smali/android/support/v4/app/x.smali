...
.method public final a(Landroid/support/v4/app/NotificationCompat$Builder;)Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroid/support/v4/app/NotificationCompat$Builder;->mContentText:Ljava/lang/CharSequence;
    ...
    iget v8, p1, Landroid/support/v4/app/NotificationCompat$Builder;->mNumber:I
    ...
    iget v11, v3, Landroid/app/Notification;->icon:I

    iget v12, v3, Landroid/app/Notification;->iconLevel:I

    invoke-virtual {v0, v11, v12}, Landroid/app/Notification$Builder;->setSmallIcon(II)Landroid/app/Notification$Builder;
    ...
    iget-object v11, v3, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;

    invoke-virtual {v0, v11, v7}, Landroid/app/Notification$Builder;->setTicker(Ljava/lang/CharSequence;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v0, v7, v11}, Landroid/app/Notification$Builder;->setSound(Landroid/net/Uri;I)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v0, v7, v11, v12}, Landroid/app/Notification$Builder;->setLights(III)Landroid/app/Notification$Builder;
    ...
    :goto_3
    invoke-virtual {v0, v9, v1}, Landroid/app/Notification$Builder;->setFullScreenIntent(Landroid/app/PendingIntent;Z)Landroid/app/Notification$Builder;
