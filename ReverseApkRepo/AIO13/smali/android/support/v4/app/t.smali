...
# direct methods
.method public constructor <init>(Landroid/support/v4/app/s;ILandroid/os/Bundle;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/app/t;->o:Landroid/support/v4/app/s;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput p2, p0, Landroid/support/v4/app/t;->a:I

    iput-object p3, p0, Landroid/support/v4/app/t;->b:Landroid/os/Bundle;

    iput-object p4, p0, Landroid/support/v4/app/t;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
...
.method final a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/t;->d:Landroid/support/v4/content/Loader;

    if-nez v0, :cond_3

    iget-object v0, p0, Landroid/support/v4/app/t;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
    ...
    iput-object v0, p0, Landroid/support/v4/app/t;->d:Landroid/support/v4/content/Loader;
    ...
    iget-object v2, p0, Landroid/support/v4/app/t;->d:Landroid/support/v4/content/Loader;
...
.method final a(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/h;->s:Ljava/lang/String;

    iget-object v1, p0, Landroid/support/v4/app/t;->o:Landroid/support/v4/app/s;

    iget-object v1, v1, Landroid/support/v4/app/s;->d:Landroid/support/v4/app/FragmentActivity;

    iget-object v1, v1, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/h;

    const-string v2, "onLoadFinished"

    iput-object v2, v1, Landroid/support/v4/app/h;->s:Ljava/lang/String;
    ...
    iput-object v1, v0, Landroid/support/v4/app/h;->s:Ljava/lang/String;
    ...
    iget-object v2, v2, Landroid/support/v4/app/FragmentActivity;->mFragments:Landroid/support/v4/app/h;

    iput-object v1, v2, Landroid/support/v4/app/h;->s:Ljava/lang/String;
...
.method final b()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/t;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
...
.method final c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/t;->a(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
...
.method final f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/t;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/t;->d:Landroid/support/v4/content/Loader;
    ...
    iput-object v3, v1, Landroid/support/v4/app/h;->s:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/t;->d:Landroid/support/v4/content/Loader;
    ...
    :cond_2
    iput-object v2, p0, Landroid/support/v4/app/t;->c:Landroid/support/v4/app/LoaderManager$LoaderCallbacks;
...
.method public final onLoadComplete(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/s;->b:Landroid/support/v4/app/p;

    iget v1, p0, Landroid/support/v4/app/t;->a:I

    invoke-virtual {v0, v1}, Landroid/support/v4/app/p;->a(I)Ljava/lang/Object;
    ...
    :cond_4
    iput-object v4, p0, Landroid/support/v4/app/t;->n:Landroid/support/v4/app/t;

    iget-object v1, p0, Landroid/support/v4/app/t;->o:Landroid/support/v4/app/s;

    iget-object v1, v1, Landroid/support/v4/app/s;->b:Landroid/support/v4/app/p;

    iget v2, p0, Landroid/support/v4/app/t;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/app/p;->a(ILjava/lang/Object;)V

    invoke-virtual {p0}, Landroid/support/v4/app/t;->f()V

    iget-object v1, p0, Landroid/support/v4/app/t;->o:Landroid/support/v4/app/s;

    invoke-virtual {v1, v0}, Landroid/support/v4/app/s;->a(Landroid/support/v4/app/t;)V
    ...
    :cond_6
    iput-object p2, p0, Landroid/support/v4/app/t;->g:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/t;->a(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V

    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/t;->o:Landroid/support/v4/app/s;

    iget-object v0, v0, Landroid/support/v4/app/s;->c:Landroid/support/v4/app/p;
    ...
    iput-boolean v1, v0, Landroid/support/v4/app/t;->f:Z
