...
.field protected mChangeObserver:Landroid/support/v4/widget/a;

.field protected mContext:Landroid/content/Context;

.field protected mCursor:Landroid/database/Cursor;

.field protected mCursorFilter:Landroid/support/v4/widget/c;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mCursorFilter:Landroid/support/v4/widget/c;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mCursorFilter:Landroid/support/v4/widget/c;
...
.method init(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    new-instance v2, Landroid/support/v4/widget/a;

    invoke-direct {v2, p0}, Landroid/support/v4/widget/a;-><init>(Landroid/support/v4/widget/CursorAdapter;)V

    iput-object v2, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/a;

    new-instance v2, Landroid/support/v4/widget/b;

    invoke-direct {v2, p0, v1}, Landroid/support/v4/widget/b;-><init>(Landroid/support/v4/widget/CursorAdapter;B)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/a;
    ...
    :cond_5
    iput-object v4, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/a;
...
.method public swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/CursorAdapter;->mChangeObserver:Landroid/support/v4/widget/a;
