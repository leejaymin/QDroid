...
.method public clear()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/cooliris/media/ImageViewTouchBase;->setImageBitmapResetBase(Landroid/graphics/Bitmap;Z)V
...
.method protected maxZoom()F
    ...
    .prologue
    .line 280
    iget-object v3, p0, Lcom/cooliris/media/ImageViewTouchBase;->mBitmapDisplayed:Lcom/cooliris/media/RotateBitmap;

    invoke-virtual {v3}, Lcom/cooliris/media/RotateBitmap;->getBitmap()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v3}, Lcom/cooliris/media/RotateBitmap;->getWidth()I

    move-result v3

    int-to-float v3, v3

    iget v4, p0, Lcom/cooliris/media/ImageViewTouchBase;->mThisWidth:I
    ...
    invoke-virtual {v3}, Lcom/cooliris/media/RotateBitmap;->getHeight()I

    move-result v3

    int-to-float v3, v3

    iget v4, p0, Lcom/cooliris/media/ImageViewTouchBase;->mThisHeight:I
...
.method public setRecycler(Lcom/cooliris/media/ImageViewTouchBase$Recycler;)V
    .locals 0
    .parameter "r"

    .prologue
    .line 71
    iput-object p1, p0, Lcom/cooliris/media/ImageViewTouchBase;->mRecycler:Lcom/cooliris/media/ImageViewTouchBase$Recycler;
...
.method protected zoomIn()V
    ...
    invoke-virtual {p0, v0}, Lcom/cooliris/media/ImageViewTouchBase;->zoomIn(F)V
...
.method protected zoomIn(F)V
    ...
    iget v3, p0, Lcom/cooliris/media/ImageViewTouchBase;->mMaxZoom:F
...
.method protected zoomOut()V
    ...
    invoke-virtual {p0, v0}, Lcom/cooliris/media/ImageViewTouchBase;->zoomOut(F)V
...
.method protected zoomOut(F)V
    ...
    iget-object v3, p0, Lcom/cooliris/media/ImageViewTouchBase;->mSuppMatrix:Landroid/graphics/Matrix;
    ...
    .line 364
    invoke-virtual {p0, v2}, Lcom/cooliris/media/ImageViewTouchBase;->getScale(Landroid/graphics/Matrix;)F
    ...
    invoke-virtual {p0, v3}, Lcom/cooliris/media/ImageViewTouchBase;->setImageMatrix(Landroid/graphics/Matrix;)V

    .line 370
    invoke-virtual {p0, v6, v6}, Lcom/cooliris/media/ImageViewTouchBase;->center(ZZ)V
