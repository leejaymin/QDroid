...
.method private a(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 6
    ...
    invoke-virtual {v0, v3, p2}, Landroid/support/v4/app/Fragment;->a(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v0, v3, p2}, Landroid/support/v4/app/a;->a(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method private t()V
    ...
    iget-boolean v3, p0, Landroid/support/v4/app/j;->e:Z
    ...
    iget v3, p0, Landroid/support/v4/app/j;->n:I

    invoke-virtual {p0, v0, v3, v2, v2}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
...
.method final a(IIIZ)V
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V

    iget-object v4, v0, Landroid/support/v4/app/Fragment;->K:Landroid/support/v4/app/s;
...
.method final a(Landroid/os/Parcelable;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/BackStackState;->a(Landroid/support/v4/app/j;)Landroid/support/v4/app/a;
...
.method final a(Landroid/support/v4/app/Fragment;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v1}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
...
.method public final a(Landroid/support/v4/app/Fragment;II)V
    ...
    :goto_1
    invoke-virtual {p0, p1, v2, p2, p3}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
...
.method final a(Landroid/support/v4/app/Fragment;III)V
    ...
    invoke-virtual {p0, p1, v0, v6, v6}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
    ...
    iput-object v0, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/j;
    ...
    invoke-static {}, Landroid/support/v4/app/Fragment;->j()Landroid/view/View;
    ...
    invoke-direct {p0, p1, p3, v1, p4}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {p0, p1, p3, v6, p4}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;IZI)Landroid/view/animation/Animation;
    ...
    invoke-direct {v2, p0, p1}, Landroid/support/v4/app/l;-><init>(Landroid/support/v4/app/j;Landroid/support/v4/app/Fragment;)V
    ...
    :cond_35
    iput-object v3, p1, Landroid/support/v4/app/Fragment;->t:Landroid/support/v4/app/FragmentActivity;

    iput-object v3, p1, Landroid/support/v4/app/Fragment;->s:Landroid/support/v4/app/j;
...
.method public final a()Z
    ...
    iget-boolean v1, p0, Landroid/support/v4/app/j;->q:Z
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/j;->s:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/app/j;->b()Z
...
.method final d()Landroid/os/Parcelable;
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v4/app/j;->a(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method public final d(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, v3, p2, p3}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
...
.method public final e(Landroid/support/v4/app/Fragment;II)V
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Landroid/support/v4/app/j;->a(Landroid/support/v4/app/Fragment;III)V
...
.method public final f()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/j;->d(I)V
...
.method public final q()Z
    ...
    invoke-static {}, Landroid/support/v4/app/Fragment;->v()Z
