...
# virtual methods
.method public createBroadcastIntent(Lorg/appcelerator/kroll/KrollInvocation;[Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 2
    ...
    invoke-direct {v0, v1}, Lorg/appcelerator/titanium/proxy/IntentProxy;-><init>(Lorg/appcelerator/titanium/TiContext;)V

    .line 256
    .local v0, intent:Lorg/appcelerator/titanium/proxy/IntentProxy;
    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lorg/appcelerator/titanium/proxy/IntentProxy;->setType(I)V

    .line 257
    invoke-virtual {v0, p0, p2}, Lorg/appcelerator/titanium/proxy/IntentProxy;->handleCreationArgs(Lorg/appcelerator/kroll/KrollModule;[Ljava/lang/Object;)V

    .line 258
    return-object v0
.end method

.method public createIntent(Lorg/appcelerator/kroll/KrollInvocation;[Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 2
    .parameter "invocation"
    .parameter "args"
...
.method public createIntentChooser(Lorg/appcelerator/kroll/KrollInvocation;Lorg/appcelerator/titanium/proxy/IntentProxy;Ljava/lang/String;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 3
    .parameter "invocation"
    .parameter "target"
    .parameter "title"
    ...
    invoke-direct {v0, v1, v2}, Lorg/appcelerator/titanium/proxy/IntentProxy;-><init>(Lorg/appcelerator/titanium/TiContext;Landroid/content/Intent;)V

    return-object v0
.end method

.method public createService(Lorg/appcelerator/kroll/KrollInvocation;Lorg/appcelerator/titanium/proxy/IntentProxy;)Lorg/appcelerator/titanium/proxy/ServiceProxy;
    .locals 3
    .parameter "invocation"
    ...
    invoke-static {v1, v2}, Lorg/appcelerator/titanium/TiContext;->createTiContext(Landroid/app/Activity;Ljava/lang/String;)Lorg/appcelerator/titanium/TiContext;
    ...
    invoke-virtual {v0, v1}, Lorg/appcelerator/titanium/TiContext;->setServiceContext(Z)V

    .line 336
    new-instance v1, Lorg/appcelerator/titanium/proxy/ServiceProxy;

    invoke-direct {v1, v0, p2}, Lorg/appcelerator/titanium/proxy/ServiceProxy;-><init>(Lorg/appcelerator/titanium/TiContext;Lorg/appcelerator/titanium/proxy/IntentProxy;)V

    return-object v1
.end method

.method public createServiceIntent(Lorg/appcelerator/kroll/KrollInvocation;[Ljava/lang/Object;)Lorg/appcelerator/titanium/proxy/IntentProxy;
    .locals 2
    .parameter "invocation"
    .parameter "args"
...
.method public isServiceRunning(Lorg/appcelerator/kroll/KrollInvocation;Lorg/appcelerator/titanium/proxy/IntentProxy;)Z
    .locals 9
    .parameter "invocation"
    .parameter "intentProxy"
    ...
    .line 314
    const-string v6, "TiAndroid"

    const-string v7, "isServiceRunning called with empty intent.  Will return false, but value is meaningless."

    invoke-static {v6, v7}, Lorg/appcelerator/titanium/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I
...
.method public startService(Lorg/appcelerator/kroll/KrollInvocation;Lorg/appcelerator/titanium/proxy/IntentProxy;)V
    .locals 4
    .parameter "invocation"
    .parameter "intentProxy"
    ...
    invoke-virtual {v2, v3}, Lorg/appcelerator/titanium/TiApplication;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;

    goto :goto_0

    .line 289
    :cond_1
    const-string v2, "TiAndroid"

    const-string v3, "Could not locate non-null activity/context/application with which to start service."
...
.method public stopService(Lorg/appcelerator/kroll/KrollInvocation;Lorg/appcelerator/titanium/proxy/IntentProxy;)V
    .locals 4
    .parameter "invocation"
    .parameter "intentProxy"
    ...
    invoke-virtual {v2, v3}, Lorg/appcelerator/titanium/TiApplication;->stopService(Landroid/content/Intent;)Z
    ...
    const-string v3, "Could not locate non-null activity/context/application with which to stop service."
