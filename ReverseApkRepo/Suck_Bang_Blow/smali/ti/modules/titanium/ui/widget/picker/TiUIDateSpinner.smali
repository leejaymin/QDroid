...
.method private createNativeView(Landroid/app/Activity;)V
    ...
    const-string v7, "dayBeforeMonth"
    ...
    invoke-virtual {v1, v7}, Lorg/appcelerator/titanium/proxy/TiViewProxy;->hasProperty(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v7}, Lorg/appcelerator/titanium/util/TiConvert;->toBoolean(Lorg/appcelerator/kroll/KrollDict;Ljava/lang/String;)Z
...
.method private setMonthAdapter(Z)V
    ...
    .line 199
    .local v8, setMinMonth:I
    const/16 v7, 0xc

    .line 201
    .local v7, setMaxMonth:I
    const/4 v2, -0x1

    .local v2, currentMin:I
    const/4 v1, -0x1

    .line 202
    .local v1, currentMax:I
    ...
    .line 222
    .local v9, width:I
    iget-boolean v10, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->numericMonths:Z
    ...
    invoke-direct {v10, v8, v7, v3, v9}, Lti/modules/titanium/ui/widget/picker/FormatNumericWheelAdapter;-><init>(IILjava/text/NumberFormat;I)V

    iput-object v10, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->monthAdapter:Lti/modules/titanium/ui/widget/picker/FormatNumericWheelAdapter;

    .line 229
    iput-boolean v11, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->ignoreItemSelection:Z

    .line 230
    iget-object v10, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->monthWheel:Lkankan/wheel/widget/WheelView;

    iget-object v11, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->monthAdapter:Lti/modules/titanium/ui/widget/picker/FormatNumericWheelAdapter;
    ...
    :cond_5
    new-instance v3, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner$MonthFormat;

    iget-object v10, p0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;->locale:Ljava/util/Locale;

    invoke-direct {v3, p0, v10}, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner$MonthFormat;-><init>(Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner;Ljava/util/Locale;)V

    .line 226
    .restart local v3       #format:Ljava/text/NumberFormat;
    move-object v0, v3

    check-cast v0, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner$MonthFormat;

    move-object v10, v0

    invoke-virtual {v10}, Lti/modules/titanium/ui/widget/picker/TiUIDateSpinner$MonthFormat;->getLongestMonthName()I
...
.method public processProperties(Lorg/appcelerator/kroll/KrollDict;)V
    ...
    const-string v4, "dayBeforeMonth"
    ...
    invoke-static {p1, v8}, Lorg/appcelerator/titanium/util/TiConvert;->toDate(Lorg/appcelerator/kroll/KrollDict;Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-static {p1, v7}, Lorg/appcelerator/titanium/util/TiConvert;->toDate(Lorg/appcelerator/kroll/KrollDict;Ljava/lang/String;)Ljava/util/Date;
...
.method public setValue(JZ)V
    ...
    invoke-virtual {v4, v6, v2}, Lorg/appcelerator/titanium/proxy/TiViewProxy;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v5, v0}, Lorg/appcelerator/titanium/proxy/TiViewProxy;->fireEvent(Ljava/lang/String;Lorg/appcelerator/kroll/KrollDict;)Z
