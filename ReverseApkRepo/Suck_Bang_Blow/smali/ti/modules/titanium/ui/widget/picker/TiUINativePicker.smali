...
.method protected fireSelectionChange(II)V
    ...
    .prologue
    .line 191
    iget-object p0, p0, Lti/modules/titanium/ui/widget/picker/TiUINativePicker;->proxy:Lorg/appcelerator/titanium/proxy/TiViewProxy;

    .end local p0
    check-cast p0, Lti/modules/titanium/ui/PickerProxy;

    invoke-virtual {p0, p1, p2}, Lti/modules/titanium/ui/PickerProxy;->fireSelectionChange(II)V
...
.method protected refreshNativeView()V
    ...
    invoke-static {v7, v8, v6}, Lorg/appcelerator/titanium/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_3
...
.method public selectRow(IIZ)V
    ...
    .prologue
    const-string v4, "TiUINativePicker"
    ...
    const-string v3, "Only one column is supported. Ignoring request to set selected row of column "
    ...
    const-string v3, "Ignoring request to select out-of-bounds row index "
