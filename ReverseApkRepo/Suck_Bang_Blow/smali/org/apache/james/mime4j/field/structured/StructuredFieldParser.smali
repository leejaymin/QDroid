...
.method public constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    .line 28
    iput-boolean v6, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->preserveFolding:Z

    .line 126
    new-array v2, v7, [I

    iput-object v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_la1:[I
    ...
    iput-object v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_expentries:Ljava/util/Vector;

    .line 233
    iput v5, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_kind:I

    .line 139
    :try_start_0
    new-instance v2, Lorg/apache/james/mime4j/field/structured/SimpleCharStream;

    const/4 v3, 0x1

    const/4 v4, 0x1

    invoke-direct {v2, p1, p2, v3, v4}, Lorg/apache/james/mime4j/field/structured/SimpleCharStream;-><init>(Ljava/io/InputStream;Ljava/lang/String;II)V

    iput-object v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_input_stream:Lorg/apache/james/mime4j/field/structured/SimpleCharStream;
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0

    .line 140
    new-instance v2, Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;

    iget-object v3, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_input_stream:Lorg/apache/james/mime4j/field/structured/SimpleCharStream;

    invoke-direct {v2, v3}, Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;-><init>(Lorg/apache/james/mime4j/field/structured/SimpleCharStream;)V

    iput-object v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->token_source:Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;

    .line 141
    new-instance v2, Lorg/apache/james/mime4j/field/structured/Token;

    invoke-direct {v2}, Lorg/apache/james/mime4j/field/structured/Token;-><init>()V
    ...
    .line 142
    iput v5, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_ntk:I

    .line 143
    iput v6, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
    ...
    iget-object v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_la1:[I
...
.method public constructor <init>(Ljava/io/Reader;)V
    ...
    .line 28
    iput-boolean v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->preserveFolding:Z
    ...
    .line 164
    iput v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
...
.method public constructor <init>(Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;)V
    ...
    .line 28
    iput-boolean v3, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->preserveFolding:Z
    ...
    .line 181
    iput v3, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
...
.method private final doParse()Ljava/lang/String;
    ...
    .line 75
    iget-object v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_la1:[I

    const/4 v5, 0x0

    iget v6, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
    ...
    .line 113
    invoke-direct {p0, v7}, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_consume_token(I)Lorg/apache/james/mime4j/field/structured/Token;

    .line 114
    new-instance v4, Lorg/apache/james/mime4j/field/structured/ParseException;

    invoke-direct {v4}, Lorg/apache/james/mime4j/field/structured/ParseException;-><init>()V
    ...
    .line 81
    .local v2, t:Lorg/apache/james/mime4j/field/structured/Token;
    if-eqz v1, :cond_4
    ...
    :cond_3
    :goto_3
    iget-object v4, v2, Lorg/apache/james/mime4j/field/structured/Token;->image:Ljava/lang/String;
    ...
    .line 90
    .end local v2           #t:Lorg/apache/james/mime4j/field/structured/Token;
    :pswitch_2
    const/16 v4, 0xb
    ...
    .line 91
    .restart local v2       #t:Lorg/apache/james/mime4j/field/structured/Token;
    iget-object v4, v2, Lorg/apache/james/mime4j/field/structured/Token;->image:Ljava/lang/String;
...
.method private final jj_consume_token(I)Lorg/apache/james/mime4j/field/structured/Token;
    ...
    .local v0, oldToken:Lorg/apache/james/mime4j/field/structured/Token;
    ...
    iput v1, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
...
.method public ReInit(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1, p2, v3, v4}, Lorg/apache/james/mime4j/field/structured/SimpleCharStream;->ReInit(Ljava/io/InputStream;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v2, v3}, Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;->ReInit(Lorg/apache/james/mime4j/field/structured/SimpleCharStream;)V
    ...
    iput v2, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
...
.method public generateParseException()Lorg/apache/james/mime4j/field/structured/ParseException;
    ...
    .line 236
    iget-object v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_expentries:Ljava/util/Vector;
    ...
    .line 241
    :cond_0
    iget v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_kind:I
    ...
    iget v5, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_gen:I
    ...
    iput-object v4, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_expentry:[I
    ...
    iget-object v5, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->jj_expentry:[I
    ...
    iget-object v5, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->token:Lorg/apache/james/mime4j/field/structured/Token;

    sget-object v6, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->tokenImage:[Ljava/lang/String;

    invoke-direct {v4, v5, v0, v6}, Lorg/apache/james/mime4j/field/structured/ParseException;-><init>(Lorg/apache/james/mime4j/field/structured/Token;[[I[Ljava/lang/String;)V
...
.method public final getToken(I)Lorg/apache/james/mime4j/field/structured/Token;
    ...
    .end local v1           #t:Lorg/apache/james/mime4j/field/structured/Token;
    .local v2, t:Lorg/apache/james/mime4j/field/structured/Token;
    :goto_0
    if-ge v0, p1, :cond_1

    .line 218
    iget-object v3, v2, Lorg/apache/james/mime4j/field/structured/Token;->next:Lorg/apache/james/mime4j/field/structured/Token;

    if-eqz v3, :cond_0

    iget-object v1, v2, Lorg/apache/james/mime4j/field/structured/Token;->next:Lorg/apache/james/mime4j/field/structured/Token;

    .line 217
    .end local v2           #t:Lorg/apache/james/mime4j/field/structured/Token;
    .restart local v1       #t:Lorg/apache/james/mime4j/field/structured/Token;
    :goto_1
    add-int/lit8 v0, v0, 0x1
    ...
    .line 219
    :cond_0
    iget-object v3, p0, Lorg/apache/james/mime4j/field/structured/StructuredFieldParser;->token_source:Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;

    invoke-virtual {v3}, Lorg/apache/james/mime4j/field/structured/StructuredFieldParserTokenManager;->getNextToken()Lorg/apache/james/mime4j/field/structured/Token;

    move-result-object v1

    iput-object v1, v2, Lorg/apache/james/mime4j/field/structured/Token;->next:Lorg/apache/james/mime4j/field/structured/Token;
...
.method public parse()Ljava/lang/String;
    ...
    .line 55
    .local v0, e:Lorg/apache/james/mime4j/field/structured/TokenMgrError;
