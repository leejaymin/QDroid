...
.method public constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    iput-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->languages:Ljava/util/ArrayList;

    .line 109
    new-array v2, v6, [I

    iput-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_la1:[I
    ...
    iput-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_expentries:Ljava/util/Vector;

    .line 216
    iput v5, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_kind:I

    .line 122
    :try_start_0
    new-instance v2, Lorg/apache/james/mime4j/field/language/SimpleCharStream;

    const/4 v3, 0x1

    const/4 v4, 0x1

    invoke-direct {v2, p1, p2, v3, v4}, Lorg/apache/james/mime4j/field/language/SimpleCharStream;-><init>(Ljava/io/InputStream;Ljava/lang/String;II)V

    iput-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_input_stream:Lorg/apache/james/mime4j/field/language/SimpleCharStream;
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0

    .line 123
    new-instance v2, Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;

    iget-object v3, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_input_stream:Lorg/apache/james/mime4j/field/language/SimpleCharStream;

    invoke-direct {v2, v3}, Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;-><init>(Lorg/apache/james/mime4j/field/language/SimpleCharStream;)V

    iput-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->token_source:Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;

    .line 124
    new-instance v2, Lorg/apache/james/mime4j/field/language/Token;

    invoke-direct {v2}, Lorg/apache/james/mime4j/field/language/Token;-><init>()V
    ...
    .line 125
    iput v5, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_ntk:I

    .line 126
    const/4 v2, 0x0

    iput v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_gen:I
    ...
    iget-object v2, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_la1:[I
...
.method public constructor <init>(Ljava/io/Reader;)V
    ...
    iput v1, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_gen:I
...
.method private final jj_consume_token(I)Lorg/apache/james/mime4j/field/language/Token;
    ...
    .local v0, oldToken:Lorg/apache/james/mime4j/field/language/Token;
...
.method public ReInit(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1, p2, v3, v4}, Lorg/apache/james/mime4j/field/language/SimpleCharStream;->ReInit(Ljava/io/InputStream;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v2, v3}, Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;->ReInit(Lorg/apache/james/mime4j/field/language/SimpleCharStream;)V
...
.method public generateParseException()Lorg/apache/james/mime4j/field/language/ParseException;
    ...
    .line 219
    iget-object v4, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_expentries:Ljava/util/Vector;
    ...
    .line 224
    :cond_0
    iget v4, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_kind:I
    ...
    .line 229
    iget-object v4, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_la1:[I

    aget v4, v4, v1

    iget v5, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_gen:I
    ...
    iput-object v4, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_expentry:[I
    ...
    iget-object v5, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_expentry:[I
    ...
    .line 248
    :cond_7
    new-instance v4, Lorg/apache/james/mime4j/field/language/ParseException;

    iget-object v5, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->token:Lorg/apache/james/mime4j/field/language/Token;

    sget-object v6, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->tokenImage:[Ljava/lang/String;

    invoke-direct {v4, v5, v0, v6}, Lorg/apache/james/mime4j/field/language/ParseException;-><init>(Lorg/apache/james/mime4j/field/language/Token;[[I[Ljava/lang/String;)V
...
.method public final getToken(I)Lorg/apache/james/mime4j/field/language/Token;
    ...
    .end local v1           #t:Lorg/apache/james/mime4j/field/language/Token;
    .local v2, t:Lorg/apache/james/mime4j/field/language/Token;
    :goto_0
    if-ge v0, p1, :cond_1

    .line 201
    iget-object v3, v2, Lorg/apache/james/mime4j/field/language/Token;->next:Lorg/apache/james/mime4j/field/language/Token;

    if-eqz v3, :cond_0

    iget-object v1, v2, Lorg/apache/james/mime4j/field/language/Token;->next:Lorg/apache/james/mime4j/field/language/Token;

    .line 200
    .end local v2           #t:Lorg/apache/james/mime4j/field/language/Token;
    .restart local v1       #t:Lorg/apache/james/mime4j/field/language/Token;
    :goto_1
    add-int/lit8 v0, v0, 0x1
    ...
    .end local v1           #t:Lorg/apache/james/mime4j/field/language/Token;
    .restart local v2       #t:Lorg/apache/james/mime4j/field/language/Token;
    goto :goto_0

    .line 202
    :cond_0
    iget-object v3, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->token_source:Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;

    invoke-virtual {v3}, Lorg/apache/james/mime4j/field/language/ContentLanguageParserTokenManager;->getNextToken()Lorg/apache/james/mime4j/field/language/Token;

    move-result-object v1

    iput-object v1, v2, Lorg/apache/james/mime4j/field/language/Token;->next:Lorg/apache/james/mime4j/field/language/Token;
...
.method public final language()Ljava/lang/String;
    ...
    .line 67
    .local v2, token:Lorg/apache/james/mime4j/field/language/Token;
    iget-object v3, v2, Lorg/apache/james/mime4j/field/language/Token;->image:Ljava/lang/String;

    invoke-virtual {v0, v3}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    .line 70
    :goto_0
    iget v3, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_ntk:I
    ...
    .line 76
    iget-object v3, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_la1:[I
    ...
    iget-object v3, p0, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->languages:Ljava/util/ArrayList;
    ...
    .line 94
    invoke-direct {p0, v5}, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_consume_token(I)Lorg/apache/james/mime4j/field/language/Token;

    .line 95
    new-instance v3, Lorg/apache/james/mime4j/field/language/ParseException;

    invoke-direct {v3}, Lorg/apache/james/mime4j/field/language/ParseException;-><init>()V
    ...
    .line 81
    :sswitch_1
    invoke-direct {p0, v6}, Lorg/apache/james/mime4j/field/language/ContentLanguageParser;->jj_consume_token(I)Lorg/apache/james/mime4j/field/language/Token;
...
.method public parse()Ljava/util/List;
    ...
    .line 39
    .local v0, e:Lorg/apache/james/mime4j/field/language/TokenMgrError;
