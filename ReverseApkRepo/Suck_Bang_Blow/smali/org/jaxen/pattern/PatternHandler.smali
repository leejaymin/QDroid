...
.method protected endLocationPath()V
    ...
    const-string v8, "endLocationPath: "
    ...
    .line 209
    .local v4, locationPath:Lorg/jaxen/pattern/LocationPathPattern;
    invoke-virtual {p0, v4}, Lorg/jaxen/pattern/PatternHandler;->push(Ljava/lang/Object;)V

    .line 210
    const/4 v1, 0x0

    .line 211
    .local v1, doneNodeTest:Z
    :cond_0
    :goto_0
    ...
    instance-of v6, v2, Lorg/jaxen/pattern/NodeTest;
    ...
    invoke-direct {v5, v2}, Lorg/jaxen/pattern/LocationPathPattern;-><init>(Lorg/jaxen/pattern/NodeTest;)V

    .line 219
    .local v5, parent:Lorg/jaxen/pattern/LocationPathPattern;
    invoke-virtual {v4, v5}, Lorg/jaxen/pattern/LocationPathPattern;->setParentPattern(Lorg/jaxen/pattern/Pattern;)V
    ...
    .line 225
    .end local v5           #parent:Lorg/jaxen/pattern/LocationPathPattern;
    .restart local v2       #filter:Ljava/lang/Object;
    :cond_1
    check-cast v2, Lorg/jaxen/pattern/NodeTest;

    .end local v2           #filter:Ljava/lang/Object;
    invoke-virtual {v4, v2}, Lorg/jaxen/pattern/LocationPathPattern;->setNodeTest(Lorg/jaxen/pattern/NodeTest;)V
    ...
    .restart local v2       #filter:Ljava/lang/Object;
    :cond_2
    instance-of v6, v2, Lorg/jaxen/expr/FilterExpr;
    ...
    .end local v2           #filter:Ljava/lang/Object;
    invoke-virtual {v4, v2}, Lorg/jaxen/pattern/LocationPathPattern;->addFilter(Lorg/jaxen/expr/FilterExpr;)V
    ...
    .restart local v2       #filter:Ljava/lang/Object;
    :cond_3
    instance-of v6, v2, Lorg/jaxen/pattern/LocationPathPattern;
    ...
    .line 235
    .restart local v5       #parent:Lorg/jaxen/pattern/LocationPathPattern;
    invoke-virtual {v4, v5}, Lorg/jaxen/pattern/LocationPathPattern;->setParentPattern(Lorg/jaxen/pattern/Pattern;)V
