...
.method protected static convertExpr(Lorg/jaxen/expr/Expr;)Lorg/jaxen/pattern/Pattern;
    ...
    .prologue
    .line 120
    instance-of v5, p0, Lorg/jaxen/expr/LocationPath;
    ...
    .restart local p0
    :cond_0
    instance-of v5, p0, Lorg/jaxen/expr/FilterExpr;

    if-eqz v5, :cond_1

    .line 126
    new-instance v1, Lorg/jaxen/pattern/LocationPathPattern;

    invoke-direct {v1}, Lorg/jaxen/pattern/LocationPathPattern;-><init>()V

    .line 127
    .local v1, answer:Lorg/jaxen/pattern/LocationPathPattern;
    ...
    .line 130
    .end local v1           #answer:Lorg/jaxen/pattern/LocationPathPattern;
    .restart local p0
    :cond_1
    instance-of v5, p0, Lorg/jaxen/expr/UnionExpr;
    ...
    .line 133
    .local v4, unionExpr:Lorg/jaxen/expr/UnionExpr;
    invoke-interface {v4}, Lorg/jaxen/expr/UnionExpr;->getLHS()Lorg/jaxen/expr/Expr;

    move-result-object v5

    invoke-static {v5}, Lorg/jaxen/pattern/PatternParser;->convertExpr(Lorg/jaxen/expr/Expr;)Lorg/jaxen/pattern/Pattern;

    move-result-object v2

    .line 134
    .local v2, lhs:Lorg/jaxen/pattern/Pattern;
    invoke-interface {v4}, Lorg/jaxen/expr/UnionExpr;->getRHS()Lorg/jaxen/expr/Expr;
    ...
    .line 135
    .local v3, rhs:Lorg/jaxen/pattern/Pattern;
    new-instance v5, Lorg/jaxen/pattern/UnionPattern;

    invoke-direct {v5, v2, v3}, Lorg/jaxen/pattern/UnionPattern;-><init>(Lorg/jaxen/pattern/Pattern;Lorg/jaxen/pattern/Pattern;)V

    goto :goto_0

    .line 139
    .end local v2           #lhs:Lorg/jaxen/pattern/Pattern;
    .end local v3           #rhs:Lorg/jaxen/pattern/Pattern;
    .end local v4           #unionExpr:Lorg/jaxen/expr/UnionExpr;
    :cond_2
    new-instance v1, Lorg/jaxen/pattern/LocationPathPattern;
    ...
    .line 140
    .restart local v1       #answer:Lorg/jaxen/pattern/LocationPathPattern;
    new-instance v5, Lorg/jaxen/expr/DefaultFilterExpr;

    new-instance v6, Lorg/jaxen/expr/PredicateSet;

    invoke-direct {v6}, Lorg/jaxen/expr/PredicateSet;-><init>()V

    invoke-direct {v5, p0, v6}, Lorg/jaxen/expr/DefaultFilterExpr;-><init>(Lorg/jaxen/expr/Expr;Lorg/jaxen/expr/PredicateSet;)V

    invoke-virtual {v1, v5}, Lorg/jaxen/pattern/LocationPathPattern;->addFilter(Lorg/jaxen/expr/FilterExpr;)V
...
.method protected static convertStep(Lorg/jaxen/pattern/LocationPathPattern;Lorg/jaxen/expr/Step;)Lorg/jaxen/pattern/LocationPathPattern;
    ...
    .line 192
    instance-of v6, p1, Lorg/jaxen/expr/DefaultAllNodeStep;
    ...
    .line 197
    sget-object v6, Lorg/jaxen/pattern/NodeTypeTest;->ATTRIBUTE_TEST:Lorg/jaxen/pattern/NodeTypeTest;

    invoke-virtual {p0, v6}, Lorg/jaxen/pattern/LocationPathPattern;->setNodeTest(Lorg/jaxen/pattern/NodeTest;)V
    ...
    .restart local p1
    :cond_0
    sget-object v6, Lorg/jaxen/pattern/NodeTypeTest;->ELEMENT_TEST:Lorg/jaxen/pattern/NodeTypeTest;
    ...
    .end local v1           #axis:I
    :cond_1
    instance-of v6, p1, Lorg/jaxen/expr/DefaultCommentNodeStep;

    if-eqz v6, :cond_2

    .line 206
    sget-object v6, Lorg/jaxen/pattern/NodeTypeTest;->COMMENT_TEST:Lorg/jaxen/pattern/NodeTypeTest;
    ...
    .line 208
    :cond_2
    instance-of v6, p1, Lorg/jaxen/expr/DefaultProcessingInstructionNodeStep;

    if-eqz v6, :cond_3

    .line 210
    sget-object v6, Lorg/jaxen/pattern/NodeTypeTest;->PROCESSING_INSTRUCTION_TEST:Lorg/jaxen/pattern/NodeTypeTest;
    ...
    .line 212
    :cond_3
    instance-of v6, p1, Lorg/jaxen/expr/DefaultTextNodeStep;

    if-eqz v6, :cond_4

    .line 214
    sget-object v6, Lorg/jaxen/pattern/TextNodeTest;->SINGLETON:Lorg/jaxen/pattern/TextNodeTest;
    ...
    .line 220
    :cond_5
    instance-of v6, p1, Lorg/jaxen/expr/DefaultNameStep;
    ...
    .line 223
    .local v3, nameStep:Lorg/jaxen/expr/DefaultNameStep;
    invoke-virtual {v3}, Lorg/jaxen/expr/DefaultNameStep;->getLocalName()Ljava/lang/String;

    move-result-object v2

    .line 224
    .local v2, localName:Ljava/lang/String;
    invoke-virtual {v3}, Lorg/jaxen/expr/DefaultNameStep;->getPrefix()Ljava/lang/String;

    move-result-object v5

    .line 225
    .local v5, prefix:Ljava/lang/String;
    invoke-virtual {v3}, Lorg/jaxen/expr/DefaultNameStep;->getAxis()I
    ...
    .line 231
    :cond_6
    invoke-virtual {v3}, Lorg/jaxen/expr/DefaultNameStep;->isMatchesAnyName()Z
    ...
    .line 254
    :goto_2
    invoke-static {p0, v3}, Lorg/jaxen/pattern/PatternParser;->convertDefaultStep(Lorg/jaxen/pattern/LocationPathPattern;Lorg/jaxen/expr/DefaultStep;)Lorg/jaxen/pattern/LocationPathPattern;
    ...
    .line 246
    :cond_9
    new-instance v6, Lorg/jaxen/pattern/NamespaceTest;

    invoke-direct {v6, v5, v4}, Lorg/jaxen/pattern/NamespaceTest;-><init>(Ljava/lang/String;S)V
    ...
    .line 251
    :cond_a
    new-instance v6, Lorg/jaxen/pattern/NameTest;

    invoke-direct {v6, v2, v4}, Lorg/jaxen/pattern/NameTest;-><init>(Ljava/lang/String;S)V
    ...
    .end local v3           #nameStep:Lorg/jaxen/expr/DefaultNameStep;
    .end local v4           #nodeType:S
    .end local v5           #prefix:Ljava/lang/String;
    :cond_b
    instance-of v6, p1, Lorg/jaxen/expr/DefaultStep;
    ...
    .restart local p1
    :cond_c
    new-instance v6, Lorg/jaxen/JaxenException;
    ...
    invoke-direct {v6, v7}, Lorg/jaxen/JaxenException;-><init>(Ljava/lang/String;)V
...
.method protected static navigationStep(Lorg/jaxen/expr/Step;)Z
    ...
    const-class v1, Lorg/jaxen/expr/DefaultStep;
