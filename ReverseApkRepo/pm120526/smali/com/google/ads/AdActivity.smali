...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/google/ads/AdActivity;->c:Lf;
...
.method public static a(Lf;Lh;)V
    .locals 4
    ...
    :try_start_0
    sget-object v1, Lcom/google/ads/AdActivity;->c:Lf;

    if-nez v1, :cond_1

    sput-object p0, Lcom/google/ads/AdActivity;->c:Lf;
    :try_end_0
    ...
    invoke-virtual {p1}, Lh;->a()Landroid/os/Bundle;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :try_start_0
    sget-object v2, Lcom/google/ads/AdActivity;->c:Lf;

    if-eqz v2, :cond_2

    sget-object v8, Lcom/google/ads/AdActivity;->c:Lf;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v2, v1}, Lh;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v2}, Lh;->b()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2}, Lh;->c()Ljava/util/HashMap;
    ...
    sget-object v3, Lcom/google/ads/AdActivity;->c:Lf;

    if-eqz v3, :cond_a

    sget-object v3, Lcom/google/ads/AdActivity;->c:Lf;

    invoke-virtual {v3}, Lf;->s()V
    ...
    invoke-static {v2, v1}, Lcom/google/ads/util/b;->a(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, v2, v6}, Lg;-><init>(Landroid/content/Context;Lcom/google/ads/f;)V
    ...
    invoke-direct {v1, v8, v2, v9, v9}, Lj;-><init>(Lf;Ljava/util/Map;ZZ)V

    invoke-virtual {v1}, Lj;->b()V
