...
# direct methods
.method public constructor <init>(Lbw;Ll;)V
    .locals 4
    ...
    iput-object p2, p0, Lcom/google/ads/internal/AdWebView;->궗:Ll;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/ads/internal/AdWebView;->癤욱븳援:Ljava/lang/ref/WeakReference;

    iput-boolean v2, p0, Lcom/google/ads/internal/AdWebView;->먯꽌:Z

    iput-boolean v2, p0, Lcom/google/ads/internal/AdWebView;->ㅼ꽑嫄:Z

    invoke-virtual {p0, v2}, Lcom/google/ads/internal/AdWebView;->setBackgroundColor(I)V

    invoke-static {p0}, Lcom/google/ads/util/AdUtil;->癤욱븳援(Landroid/webkit/WebView;)V
    ...
    invoke-direct {v1, p0}, Lat;-><init>(Lcom/google/ads/internal/AdWebView;)V
    ...
    invoke-static {v0, p1}, Ldf;->癤욱븳援(Landroid/webkit/WebSettings;Lbw;)V
    ...
    invoke-direct {v0, p1}, Ldq;-><init>(Lbw;)V
    ...
    invoke-direct {v0, p1}, Ldh;-><init>(Lbw;)V
...
.method protected declared-synchronized onMeasure(II)V
    ...
    :cond_0
    :try_start_1
    iget-object v1, p0, Lcom/google/ads/internal/AdWebView;->궗:Ll;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/google/ads/internal/AdWebView;->먯꽌:Z
    ...
    iget-object v6, p0, Lcom/google/ads/internal/AdWebView;->궗:Ll;

    invoke-virtual {v6}, Ll;->癤욱븳援()I
    ...
    iget-object v7, p0, Lcom/google/ads/internal/AdWebView;->궗:Ll;

    invoke-virtual {v7}, Ll;->궗()I
...
.method public declared-synchronized setAdSize(Ll;)V
    .locals 1

    monitor-enter p0

    :try_start_0
    iput-object p1, p0, Lcom/google/ads/internal/AdWebView;->궗:Ll;
...
.method public setIsExpandedMraid(Z)V
    ...
    iput-boolean p1, p0, Lcom/google/ads/internal/AdWebView;->먯꽌:Z
...
.method public ㅼ꽑嫄()Lcom/google/ads/AdActivity;
    .locals 1

    iget-object v0, p0, Lcom/google/ads/internal/AdWebView;->癤욱븳援:Ljava/lang/ref/WeakReference;
...
.method public 弱밧()Z
    ...
    iget-boolean v0, p0, Lcom/google/ads/internal/AdWebView;->ㅼ꽑嫄:Z
...
.method public 궗()V
    ...
    invoke-static {p0}, Ldf;->癤욱븳援(Landroid/view/View;)V

    :cond_0
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/ads/internal/AdWebView;->ㅼ꽑嫄:Z
...
.method public 먯꽌()V
    ...
    invoke-static {p0}, Ldf;->궗(Landroid/view/View;)V
